...
<section class="banner__section__contact">
        ...
        <div class="row pt-5  mt-5 align-items-center">
            <div class="col-lg-6 pt-5">
                <div class="banner__info">
                 <h6 class="text-white">Book My Pandit</h6>
                 <h2 class="text-white">Choose According to you Event Timings</h2>
    ...
    <section>
            ...
            <div class="row contact__form mt-5 pt-4">
                <h4 class="primary-textcolor mb-3">Booking form</h4>
                <div class="col-lg-6">
                    <form action="#" method="POST" class="row g-4">
                        
                        <div class="col-md-6">
                        <select class="form-control"  name="pandit">
                        <option>Choose your pandit</option>
                        <option>pandit1</option>
                        <option>pandit2</option>
                        <option>pandit3</option>
                        <option >pandit4</option>
                        ...
                        <div class="col-md-6">
                        <input type="time" class="form-control" name="time"  placeholder="expriy date">
                        </div>
        ...
        <div class="container pt-5 pb-3">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <p class="text-white mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Alias,
                        reiciendis.
                    </p>
                ...
                <div class="col-md-4">
                    <h4 class="text-white line mb-3">Socail Link</h4>
...
$sql ="
INSERT INTO `appointment`( `panditname`, `event`, `date`, `time`, `aname`, `alast`, `aaddress`, `amobile`) VALUES 
('$pandit','$event','$date','$time','$name','$last','$address','$mobile')
